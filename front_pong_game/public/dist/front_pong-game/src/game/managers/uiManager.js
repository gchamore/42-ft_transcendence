...
export class UIManager {
    constructor(context, canvas) {
        ...
        this.BLINK_INTERVAL = GameConfig.BLINK_INTERVAL;
        this.activePowerupsByType = new Map();
    ...
    drawStartMessage(timestamp, gameStarted, playerNumber, servingPlayer) {
        if (!gameStarted) {
    ...
    drawDisconnectionMessage(message, isWinner) {
        this.context.save();
    ...
    drawGameOverMessage(timestamp, winnerNumber, message) {
    ...
    drawWaitingForRematch(timestamp) {
        this.context.save();
        this.context.fillStyle = 'rgba(0, 0, 0, 0.7)';
        this.context.fillRect(0, 0, this.canvas.width, this.canvas.height);
        // Set up text styling
    ...
    addActivePowerup(powerupId, type, player) {
